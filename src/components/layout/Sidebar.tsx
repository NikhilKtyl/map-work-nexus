  ...
  return (
    <aside className="w-64 bg-sidebar border-r border-sidebar-border flex flex-col h-screen fixed left-0 top-0">
      ...
      <div className="h-16 flex items-center gap-3 px-6 border-b border-sidebar-border">
        ...
        <span className="text-xl font-bold text-sidebar-foreground">BerryTech</span>
      </div>
      ...
      {user && (
        <div className="p-4 border-t border-sidebar-border">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-sidebar-accent flex items-center justify-center text-sm font-medium text-sidebar-foreground">
